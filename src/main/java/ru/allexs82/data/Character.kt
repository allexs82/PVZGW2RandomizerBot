...
import ru.allexs82.data.enums.Classes
import ru.allexs82.data.enums.Sides
import kotlin.random.Random

sealed class Character(open val characterName: String, val characterClass: Classes, val side: Sides) {
    // Plant characters
    data class Citron(override val characterName: String) : Character(characterName, Classes.CITRON, Sides.PLANTS)
    data class Rose(override val characterName: String) : Character(characterName, Classes.ROSE, Sides.PLANTS)
    data class Corn(override val characterName: String) : Character(characterName, Classes.CORN, Sides.PLANTS)
    data class Peashooter(override val characterName: String) : Character(characterName, Classes.PEASHOOTER, Sides.PLANTS)
    data class Chomper(override val characterName: String) : Character(characterName, Classes.CHOMPER, Sides.PLANTS)
    data class Sunflower(override val characterName: String) : Character(characterName, Classes.SUNFLOWER, Sides.PLANTS)
    data class Cactus(override val characterName: String) : Character(characterName, Classes.CACTUS, Sides.PLANTS)
    data class Torchwood(override val characterName: String) : Character(characterName, Classes.TORCHWOOD, Sides.PLANTS)

    // Zombie characters
    data class Imp(override val characterName: String) : Character(characterName, Classes.IMP, Sides.ZOMBIES)
    data class SuperBrainz(override val characterName: String) : Character(characterName, Classes.SUPER_BRAINZ, Sides.ZOMBIES)
    data class Captain(override val characterName: String) : Character(characterName, Classes.CAPTAIN, Sides.ZOMBIES)
    data class Soldier(override val characterName: String) : Character(characterName, Classes.SOLDIER, Sides.ZOMBIES)
    data class Engineer(override val characterName: String) : Character(characterName, Classes.ENGINEER, Sides.ZOMBIES)
    data class Scientist(override val characterName: String) : Character(characterName, Classes.SCIENTIST, Sides.ZOMBIES)
    data class AllStar(override val characterName: String) : Character(characterName, Classes.ALL_STAR, Sides.ZOMBIES)
    data class HoverGoat(override val characterName: String) : Character(characterName, Classes.HOVER_GOAT, Sides.ZOMBIES)

    companion object {
        fun getRandomCharacter(side: Sides): Character {
        ...
        val allCharacters = (allPlants + allZombies).toHashSet()
    }
}
